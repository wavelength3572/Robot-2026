...
/**
 * Configuration for MiniBot2026 - 14" x 14" chassis with NEO Vortex drive motors Based on
 * MiniBot-2025 configuration from wavelength3572/MiniBot-2025
 */
public class MiniBotConfig implements RobotConfig {
  ...
  // Module zero rotations (needs calibration for MiniBot)
