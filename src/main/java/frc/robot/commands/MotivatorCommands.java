...
public class MotivatorCommands {
  ...
  public static Command feedforwardCharacterization(Motivator motivator) {
    ...
    return Commands.sequence(
        ...
        Commands.run(
                () -> {
                  motivator.runCharacterization(0.0);
                },
                motivator)
        ...
        Commands.run(
                () -> {
                  ...
                  motivator.runCharacterization(voltage);
                  velocitySamples.add(motivator.getFFCharacterizationVelocity());
            ...
            .finallyDo(
                () -> {
                  ...
                  System.out.println("********** Motivator FF Characterization Results **********");
