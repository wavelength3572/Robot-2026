...
public class ShotVisualizer {
  ...
  public void update(ShotSnapshot snapshot) {
    logFuelStatus();
    // Suppress trajectory in neutral trench/bump zones — hood is clamped and robot won't fire.
    // Alliance trench is NOT suppressed so FixedHeight strategy can show its arc.
